...
const NavBar = () => {
    ...
    <div className='flex justify-between items-center w-full h-20 px-4 text-white bg-black fixed'>
			...
			{nav && (
				<ul className='flex flex-col justify-center items-center absolute top-0 left-0 w-full h-screen bg-gradient-to-b from-orange-600 to-gray-800 text-gray-500'>
					{links.map(({id, link}) => (
						<li 
						key={id} 
